...
-------------------------------------------------------------------------------
20210901	Lucky		First release(v1.0)
*/
...
// Public APIs
	...
	// Delete internal memory fo Raster band
	void deleteRasterData(float** d) const;
	...
	SatImageFileType fileType() const;
...
protected:
	...
	SatImageFileType _type = SINGLE_FILE;
	QMutex _mutex;
};
